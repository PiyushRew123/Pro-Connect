...
const ProfilePage = () => {
    ...
    useEffect(()=>{
        ...
        let post =postReducer.posts.filter((post)=>{
            ...
            return post.userId.username===authState.profile.userId.username
          })

          setUserPosts(post);}
    },[authState.profile,postReducer.posts]);
  ...
  return (
    ...
    <img  alt="backdrop/" src={`${BASE_URL}/${userProfile.userId.profilePicture}`} />
