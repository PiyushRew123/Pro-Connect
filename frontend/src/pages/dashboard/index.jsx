...
import { createPost, deletePost, getAllComments, getAllPosts, increementLikes, postComment } from "@/config/redux/action/postAction";
         ...
         <DashboardLayout>
          <div className={styles.scrollComponent}>
            ...
            <div className={styles.createPostContainer}>
              ...
              <img  className={styles.userProfile}  src={`${BASE_URL}/${authState.user.profilePicture}`} alt="" />

              <textarea 
              onChange={(e)=>setpostContent(e.target.value)}
              value={postContent}
              placeholder="What's in your mind?" 
              className={styles.textAreaOfContent} name="" id="">Hello bro</textarea>
              ...
              return(
                <div key={post._id} className={styles.singleCard}>
                  ...
                  <div className={styles.singleCard_image}>
                    ...
                    {post.media!==""? <img width="100%"src={`${BASE_URL}/${post.media}`} alt="" />:<></>}
                  </div>

                          <div className={styles.optionsContainer}>

                            <div onClick={async()=>{
                              await dispatch(increementLikes({post_id:post._id}));
                              dispatch(getAllPosts());
                            }}
                  ...
                  <div>
                    ...
                    return(
                      <div className={styles.singleComment} key={postComment._id}>
                        ...
                        <p style={{fontSize:"0.8rem"}}> @{postComment.userId.username}</p>
                        </div>
